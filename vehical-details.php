...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,IDName,IDNo,message,Status) VALUES(:useremail,:vhid,:idname,:idno,:message,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':useremail',$useremail,PDO::PARAM_STR);
$query->bindParam(':vhid',$vhid,PDO::PARAM_STR);
$query->bindParam(':idname',$idname,PDO::PARAM_STR);
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>Ksh<?php echo htmlentities($result->Price);?> </p>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="idno" placeholder="National ID No." required>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">Ksh<?php echo htmlentities($result->Price);?></p>
